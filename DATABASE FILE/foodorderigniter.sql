...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Des 2022 pada 06.06
...
(30, 0, 'Menu Nasi Besek', 'Ini Menu nasi besek', 14000, 'Menu_Nasi_Besek.jpg'),
(31, 0, 'Menu Nasi Kotak Hantaran', 'Menu Nasi Kotak Hantaran', 15000, 'Menu_Nasi_Kotak_Hantaran.jpg'),
(32, 0, 'Menu Nasi Tumpeng', 'nasi tumpeng adalah makanan masyarakat Jawa yang penyajian nasinya dibentuk kerucut dan ditata bersama dengan lauk-pauknya. Olahan nasi yang dipakai umumnya berupa nasi kuning, nasi putih biasa, atau nasi uduk.', 15000, 'Menu_Nasi_Tumpeng_.jpg'),
(33, 0, 'Menu Prasmanan', 'Menu Prasmanan adalah penyajian makanan dalam pesta maupun restoran dengan meletakkan makanan pada meja panjang dan pengunjung mengambil sendiri menu yang diinginkan.', 1500000, 'Menu_Prasmanan_.jpg'),
(34, 0, 'Menu Nasi Tumpeng Mini', 'Tumpeng atau nasi tumpeng adalah makanan masyarakat Jawa yang penyajian nasinya dibentuk kerucut dan ditata bersama dengan lauk-pauknya. Olahan nasi yang dipakai umumnya berupa nasi kuning, nasi putih biasa, atau nasi uduk. Dengan Ukuran Yang lebih mini a', 150000, 'Menu_Tumpeng_Mini.jpg');
...
(7, 0, 'Menu Paket Nasi Kotak', 'Terdapat Paket 1 sampai 3 dengan variasi yang berbeda beda', 500000, '1.png'),
(8, 0, 'Paket Nasi Kotak', 'Terdapat Paket 4, A dan B dengan variasi yang berbeda beda', 550000, '2.png'),
(9, 0, 'Paket Nasi Kotak', 'Terdapat Paket Su Tak 1 sampai 3 dengan variasi yang berbeda beda', 600000, '3.png'),
(10, 0, 'Paket Nasi Kotak', 'Terdapat Paket Su Tak 4 sampai 6 dengan variasi yang berbeda beda', 600000, '4.png'),
(11, 0, 'Paket Nasi Kotak', 'Terdapat Paket Su Tak 7 dan 8 dengan variasi yang berbeda beda', 700000, '5.png'),
(12, 0, 'Paket Menu Prasmanan', 'Menu Prasmanan adalah penyajian makanan dalam pesta maupun restoran dengan meletakkan makanan pada meja panjang dan pengunjung mengambil sendiri menu yang diinginkan. dengan paket Su Tra 1 dan 2 yang berbeda beda menu', 1500000, '6.png'),
(13, 0, 'Paket Menu Prasmanan', 'Menu Prasmanan adalah penyajian makanan dalam pesta maupun restoran dengan meletakkan makanan pada meja panjang dan pengunjung mengambil sendiri menu yang diinginkan. dengan paket Su Tra 3 dan 4 yang berbeda beda menu', 1600000, '7.png');
